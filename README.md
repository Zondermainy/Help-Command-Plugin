...
Это форк оригинального плагина HelpCommand (v2.9.2), обновлённый для совместимости с серверами на базе **Purpur/Paper 26.2**. Оригинальный плагин поддерживал Spigot 1.18–1.20.4 — этот форк добавляет поддержку новой платформы.
